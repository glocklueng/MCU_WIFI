		 ...
		 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
  int *workspace = (int*)mem_malloc(sizeof(int)*DCTSIZE2);
  if(!workspace)
  	return;
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
  int *workspace = (int*)mem_malloc(sizeof(int)*49);
  if(!workspace)
  	return;
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
  	int *workspace = (int*)mem_malloc(sizeof(int)*36);
  if(!workspace)
  	return;
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
  	int *workspace = (int*)mem_malloc(sizeof(int)*25);
  if(!workspace)
  	return;
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
  	int *workspace = (int*)mem_malloc(sizeof(int)*16);
  if(!workspace)
  	return;
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
	int *workspace = (int*)mem_malloc(sizeof(int)*9);
  if(!workspace)
  	return;
  /* Pass 1: process columns from input, store into work array. */
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
	  int *workspace = (int*)mem_malloc(sizeof(int)*72);
		if(!workspace)
		  return;
		 ...
		 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
	  int *workspace = (int*)mem_malloc(sizeof(int)*80);
		if(!workspace)
		  return;
		 ...
		 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
	  int *workspace = (int*)mem_malloc(sizeof(int)*88);
		if(!workspace)
		  return;
		 ...
		 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
	  int *workspace = (int*)mem_malloc(sizeof(int)*8*12);
		if(!workspace)
		  return;
		 ...
		 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
	  int *workspace = (int*)mem_malloc(sizeof(int)*8*13);
		if(!workspace)
		  return;
		 ...
		 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
	  int *workspace = (int*)mem_malloc(sizeof(int)*8*14);
		if(!workspace)
		  return;
		 ...
		 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
	  int *workspace = (int*)mem_malloc(sizeof(int)*8*15);
		if(!workspace)
		  return;
		 ...
		 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
	  int *workspace = (int*)mem_malloc(sizeof(int)*8*16);
		if(!workspace)
		  return;
		...
		JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
	  int *workspace = (int*)mem_malloc(sizeof(int)*64);
		if(!workspace)
		  return;
		...
		JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
	  int *workspace = (int*)mem_malloc(sizeof(int)*56);
		if(!workspace)
		  return;
		...
		JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
	  int *workspace = (int*)mem_malloc(sizeof(int)*48);
		if(!workspace)
		  return;
		...
		JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
	  int *workspace = (int*)mem_malloc(sizeof(int)*40);
		if(!workspace)
		  return;
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
	  int *workspace = (int*)mem_malloc(sizeof(int)*32);
		if(!workspace)
		  return;
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
	  int *workspace = (int*)mem_malloc(sizeof(int)*18);
		if(!workspace)
		  return;
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
	  INT32 *workspace = (INT32*)mem_malloc(sizeof(int)*8);
		if(!workspace)
		  return;
		...
		JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
	  int *workspace = (int*)mem_malloc(sizeof(int)*7*14);
		if(!workspace)
		  return;
		...
		JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
	  int *workspace = (int*)mem_malloc(sizeof(int)*6*12);
		if(!workspace)
		  return;
		...
		JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  SHIFT_TEMPS
	  int *workspace = (int*)mem_malloc(sizeof(int)*50);
		if(!workspace)
		  return;
