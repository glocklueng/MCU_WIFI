 ...
 * the second part of the example1Èø´ïÊ¡.
 */
...
JSAMPLE * image_buffer = (JSAMPLE *)image_example;	/* Points to large array of R,G,B-order data */
int image_height = 64;	/* Number of rows in image */
int image_width = 64;		/* Number of columns in image */
