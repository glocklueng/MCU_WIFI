 ...
 ******************************************************************************/
#define OS_TIMER 	OS_TMR
#define OS_NDIS_MINIPORT_TIMER	OS_TIMER
...
#define tasklet_hi_schedule(_pTask)		RTMP_OS_TASKLET_SCHE(_pTask)	
...
#define RTMP_OS_TASKLET_INIT(__pAd, __pTasklet, __pFunc, __Data)	\
		RtmpOsTaskletInit(__pAd, __pTasklet, __pFunc, __Data, &(__pAd)->RscTaskletMemList)
