...
#define MAX_NUMBER_OF_MAC				2	/* if MAX_MBSSID_NUM is 8, this value can't be larger than 211 */
...
typedef struct GNU_PACKED _NDIS_802_11_CONFIGURATION_FH {
	ULONG Length;		/* Length of structure */
...
typedef struct GNU_PACKED _NDIS_802_11_CONFIGURATION {
	ULONG Length;		/* Length of structure */
...
#define MAX_PMKID_COUNT		1  //8 edit by lkc
...
typedef struct GNU_PACKED _RT_802_11_ACL_ENTRY {
	UCHAR Addr[MAC_ADDR_LENGTH];
	USHORT Rsv;
