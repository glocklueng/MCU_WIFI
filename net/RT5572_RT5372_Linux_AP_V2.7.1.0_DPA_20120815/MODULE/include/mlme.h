...
#ifdef CONFIG_AP_SUPPORT
#define MAX_LEN_OF_MLME_QUEUE            20			//10//20 //10 Mlme??¨¢D3¡è ,2??¨¹¨¬??¨¬
#endif // CONFIG_AP_SUPPORT //
...
typedef struct {
	...
	NDIS_802_11_AUTHENTICATION_MODE	AuthMode;		//add by lck //desire ap
	NDIS_802_11_WEP_STATUS	WepStatus;				//add by lck
