...
#ifdef RTMP_MAC_USB
#define TX_RING_SIZE            2 // 1
#define PRIO_RING_SIZE          2
#define MGMT_RING_SIZE       	2//32 // PRIO_RING_SIZE,D?¨®¨²2¨º¡À?¨¢¡ä¨°¨®?full, ¡äy2¨¦
#ifdef INF_AMAZON_SE
...
#define HW_BEACON_MAX_NUM		2//16

#define MAX_MBSSID_NUM(__pAd)		HW_BEACON_MAX_NUM
...
#define HASH_TABLE_SIZE                 1	/* Size of hash tab must be power of 2. */
