...
const struct _MATProtoOps MATProtoPPPoEDisHandle =
{
	MATProto_PPPoEDis_Init,
	MATProto_PPPoEDis_Tx,
	MATProto_PPPoEDis_Rx,
	MATProto_PPPoEDis_Exit,
};

/* Declaration of protocol handler for PPPoE Session stage */
const struct _MATProtoOps MATProtoPPPoESesHandle =
{
	MATProto_PPPoESes_Init,
	MATProto_PPPoESes_Tx,
	MATProto_PPPoESes_Rx,
	MATProto_PPPoESes_Exit,
};
