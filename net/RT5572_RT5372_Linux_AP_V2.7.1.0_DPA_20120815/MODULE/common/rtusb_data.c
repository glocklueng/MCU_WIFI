...
/*	UINT			Index;*/
	...
	{
		p_err("1");
		p_err("CurWritePosition:%d, NextBulkOutPosition:%d,e:%d\n", pHTTXContext->CurWritePosition, 
	...
	{
		p_err("2, nextpos:%d, NumberRequired:%d", pHTTXContext->NextBulkOutPosition, NumberRequired);
		RTUSB_SET_BULK_FLAG(pAd, (fRTUSB_BULK_OUT_DATA_NORMAL << BulkOutPipeId));
	}
	else if (pHTTXContext->bCurWriting == TRUE)
	{
