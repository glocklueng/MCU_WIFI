...
const struct ieee80211_rate Cfg80211_SupRate[12] = {
	{
		 /*.flags = */IEEE80211_RATE_SHORT_PREAMBLE,  /*.bitrate = */10,  /*.hw_value
	= */0,  /*.hw_value_short = */0, 
	} , 
	{
		 /*.flags =*/IEEE80211_RATE_SHORT_PREAMBLE,  /*.bitrate = */20,  /*.hw_value 
	= */1,  /*.hw_value_short = */1, 
	}
	, 
	{
		 /*.flags = */IEEE80211_RATE_SHORT_PREAMBLE,  /*.bitrate = */55,  /*.hw_value
	= */2,  /*.hw_value_short = */2, 
	}
	, 
	{
		 /*.flags = */IEEE80211_RATE_SHORT_PREAMBLE,  /*.bitrate = */110, 
	/*.hw_value = */3,  /*.hw_value_short = */3, 
	}
	, 
	{
		 /*.flags = */0,  /*.bitrate = */60,  /*.hw_value = */4,  /*.hw_value_short =
	*/4, 
	}
	, 
	{
		 /*.flags = */0,  /*.bitrate = */90,  /*.hw_value = */5,  /*.hw_value_short =
	*/5, 
	}
	, 
	{
		 /*.flags = */0,  /*.bitrate = */120,  /*.hw_value = */6,  /*.hw_value_short 
	= */6, 
	}
	, 
	{
		 /*.flags = */0,  /*.bitrate = */180,  /*.hw_value = */7,  /*.hw_value_short 
	= */7, 
	}
	, 
	{
		 /*.flags = */0,  /*.bitrate = */240,  /*.hw_value = */8,  /*.hw_value_short 
	= */8, 
	}
	, 
	{
		 /*.flags = */0,  /*.bitrate = */360,  /*.hw_value = */9,  /*.hw_value_short 
	= */9, 
	}
	, 
	{
	...
	, 
	{
		 /*.flags = */0,  /*.bitrate =*/540,  /*.hw_value = */11,  /*.hw_value_short 
	= */11, 
	}
	, 
};
