...
const UCHAR PowerConstraintIE[3] = {IE_POWER_CONSTRAINT, 1, 3};
...
/*	UCHAR         RSNIe=IE_WPA, RSNIe2=IE_WPA2; */
	...
	if(pAd->ApCfg.MBSSID[apidx].BeaconBuf == 0)
		pAd->ApCfg.MBSSID[apidx].BeaconBuf = (CHAR*)mem_malloc(MAX_BEACON_SIZE);
#endif
	...
	MgtMacHeaderInit(pAd, &BcnHdr, SUBTYPE_BEACON, 0, (PUCHAR)BROADCAST_ADDR, 
	...
	MakeOutgoingFrame(pBeaconFrame,                  &FrameLen,
					(sizeof(HEADER_802_11)  - 1/*wsum*/),           &BcnHdr, 
...
/*		UCHAR TmpFrame[256]; */
	...
	*/
	...
	pAd->ApCfg.MBSSID[apidx].CapabilityInfoLocationInBeacon = (sizeof(HEADER_802_11)  - 1/*wsum*/) + TIMESTAMP_LEN + 2;
}
...
/*
	#if MEMORY_OPTIMIZATION
	if(pAd->ApCfg.MBSSID[apidx].BeaconBuf){
		mem_free(pAd->ApCfg.MBSSID[apidx].BeaconBuf);
		pAd->ApCfg.MBSSID[apidx].BeaconBuf = 0;
	}else
		p_err_fun;
