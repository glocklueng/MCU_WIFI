...
static  VOID AutoChannelSkipListSetDirty(
	IN PRTMP_ADAPTER	pAd)
{
	UCHAR i;
...
static  BOOLEAN BW40_ChannelCheck(
	IN UCHAR ch)
{
	INT i;
	BOOLEAN result = TRUE;
...
static  UCHAR SelectClearChannelRandom(
	IN PRTMP_ADAPTER pAd
	)
{
...
/* 
	...
	==========================================================================
 */
static  UCHAR SelectClearChannelCCA(
	IN PRTMP_ADAPTER pAd
	)
{
...
static  UCHAR SelectClearChannelApCnt(
	IN PRTMP_ADAPTER pAd
	)
{
    /*PBSSINFO pBssInfoTab = pAd->pBssInfoTab; */
