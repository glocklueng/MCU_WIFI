	...
	IN UINT32 TxIdx)
{
	...
	if (pNullContext->InUse == FALSE)
	{
		...
		NdisZeroMemory(&(pAd->NullFrame), (sizeof(HEADER_802_11)  - 1/*wsum*/));
		...
		RTMPMoveMemory(&pAd->NullContext.TransferBuffer->field.WirelessPacket[TXINFO_SIZE + TXWISize],
			&pAd->NullFrame, (sizeof(HEADER_802_11)  - 1/*wsum*/));

		pDest = &(pAd->NullContext.TransferBuffer->field.WirelessPacket[TXINFO_SIZE + TXWISize + (sizeof(HEADER_802_11)  - 1/*wsum*/)]);
...
#endif /* RALINK_QA */
		{
		    for (pos = 0; pos < (pATEInfo->TxLength - (sizeof(HEADER_802_11)  - 1/*wsum*/)); pos++)
		    {
