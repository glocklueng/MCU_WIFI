	...
	IN PUCHAR				pInitTxRateIdx)
{
	do
	{
		...
		{
			*ppTable = (PUCHAR)RateSwitchTable;
			break;
		}
		...
		{/* 11BGN 1S AP*/
			...
			if ((pAd->LatchRfRegs.Channel <= 14) && (pEntry->SupportRateMode & (SUPPORT_CCK_MODE)))
				*ppTable = (PUCHAR)RateSwitchTable11BGN1S;
			else
				*ppTable = (PUCHAR)RateSwitchTable11N1SForABand;
...
#endif /* NEW_RATE_ADAPT_SUPPORT */
			if ((pAd->LatchRfRegs.Channel <= 14) && (pEntry->SupportRateMode & (SUPPORT_CCK_MODE)))
				*ppTable = (PUCHAR)RateSwitchTable11BGN2S;
			else
				*ppTable = (PUCHAR)RateSwitchTable11BGN2SForABand;
		...
		{/* 11N 1S AP*/
...
#endif /* AGS_SUPPORT */
			{
				...
				if (pAd->LatchRfRegs.Channel <= 14)
					*ppTable = (PUCHAR)RateSwitchTable11N1S;
				else
					*ppTable = (PUCHAR)RateSwitchTable11N1SForABand;
			}
			break;
...
#endif /* NEW_RATE_ADAPT_SUPPORT */
				if (pAd->LatchRfRegs.Channel <= 14)
					*ppTable = (PUCHAR)RateSwitchTable11N2S;
				else
					*ppTable = (PUCHAR)RateSwitchTable11N2SForABand;			
			}
			break;
		}
		...
		{/* B only AP*/
			*ppTable = (PUCHAR)RateSwitchTable11B;			
			break;
		}
		...
		{/* B/G  mixed AP*/
			*ppTable = (PUCHAR)RateSwitchTable11BG;			
			break;
		}
		...
		{/* G only AP*/
			*ppTable = (PUCHAR)RateSwitchTable11G;			
			break;
		}
#ifdef DOT11_N_SUPPORT
#ifdef CONFIG_AP_SUPPORT
