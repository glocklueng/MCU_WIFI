...
FREQUENCY_ITEM *FreqItems3020 = (FREQUENCY_ITEM *)RtmpFreqItems3020;
	...
	IN RTMP_ADAPTER			*pAd)
{
	...
	pChipCap->BcnMaxHwNum = HW_BEACON_MAX_NUM/*16*/;
...
*/
#ifdef APCLI_SUPPORT
	pChipCap->BcnMaxNum = 1;
#else
	pChipCap->BcnMaxNum = 2;
#endif /* APCLI_SUPPORT */
	...
	for(i = 0;i < HW_BEACON_MAX_NUM; i++)
		pChipCap->BcnBase[i] = 0x4000 + i*0x200;
	/*
	...
	IN RTMP_ADAPTER *pAd)
{
	...
	pChipCap->BcnMaxHwNum = HW_BEACON_MAX_NUM/*8*/;
	...
	pChipCap->BcnMaxHwSize = 0x1000;
		...
		{
			for(i = 0;i < HW_BEACON_MAX_NUM; i++)
				pChipCap->BcnBase[i] = 0xc000 + i*0x200;
			/*
		...
		{
		for(i = 0;i < HW_BEACON_MAX_NUM; i++)
			pChipCap->BcnBase[i] = 0x7800 + i*0x200;
		/*
	...
	IN VOID			*pCB)
{
	...
	DBGPRINT(RT_DEBUG_TRACE, ("MACVersion=%x!\n", pAd->MACVersion));
