...
const UCHAR MT7601_EeBuffer[EEPROM_SIZE] = {
...
const static RTMP_REG_PAIR	MT7601_MACRegTable[] = {
...
//1004 BBP CR
const static RTMP_REG_PAIR MT7601_BBP_InitRegTb[] = {
	/* TX/RX Controls */
	{BBP_R1, 0x04},
	{BBP_R4, 0x40},
	{BBP_R20, 0x06},
...
const RTMP_REG_PAIR MT7601_BBP_BW20RegTb[] = {
	{BBP_R69, 0x12},
	{BBP_R91, 0x07},
	/* 0x23 */
	{BBP_R195, 0x23},
...
const RTMP_REG_PAIR MT7601_BBP_BW40RegTb[] = {
	{BBP_R69, 0x15},
	{BBP_R91, 0x04},
	/* 0x23 */
	{BBP_R195, 0x23},
...
const static RTMP_REG_PAIR MT7601_BBP_CommonRegTb[] = {
	{BBP_R75, 0x60},
	{BBP_R92, 0x02},
	/* 0x88 */
	{BBP_R195, 0x88},
...
const RTMP_REG_PAIR MT7601_BBP_HighTempBW20RegTb[] = {
	{BBP_R69, 0x12},
	{BBP_R91, 0x07},
	/* 0x23 */
	{BBP_R195, 0x23},
...
const RTMP_REG_PAIR MT7601_BBP_HighTempBW40RegTb[] = {
	{BBP_R69, 0x15},
	{BBP_R91, 0x04},
	/* 0x23 */
	{BBP_R195, 0x23},
...
const static RTMP_REG_PAIR MT7601_BBP_HighTempCommonRegTb[] = {
	{BBP_R75, 0x60},
	{BBP_R92, 0x02},
	/* 0x88 */
	{BBP_R195, 0x88},
...
const RTMP_REG_PAIR MT7601_BBP_LowTempBW20RegTb[] = {
	{BBP_R69, 0x12},
	{BBP_R75, 0x5E},
	{BBP_R91, 0x07},
	{BBP_R92, 0x02},	
...
const RTMP_REG_PAIR MT7601_BBP_LowTempBW40RegTb[] = {
	{BBP_R69, 0x15},
	{BBP_R75, 0x5C},
	{BBP_R91, 0x04},
	{BBP_R92, 0x03},	
...
static RTMP_REG_PAIR MT7601_BBP_LowTempCommonRegTb[] = {0, 0};
...
const static BANK_RF_REG_PAIR MT7601_RF_Central_RegTb[] = {
/*
...
const static BANK_RF_REG_PAIR MT7601_RF_Channel_RegTb[] = {
...
const static BANK_RF_REG_PAIR MT7601_RF_VGA_RegTb[] = {
...
static int MT7601_ChipSwitchChannel(
...
int MT7601UsbAsicRadioOff(RTMP_ADAPTER *pAd, UCHAR Stage)
{
	UINT32 Value, ret;
	...
	if (Stage == MLME_RADIO_OFF)
		AndesPwrSavingOP(pAd, RADIO_OFF, 1, 0, 0, 0, 0);
...
VOID MT7601UsbAsicRadioOn(RTMP_ADAPTER *pAd, UCHAR Stage)
{
	...
	if (Stage == MLME_RADIO_ON)
		AndesPwrSavingOP(pAd, RADIO_ON, 1, 0, 0, 0, 0);
...
INT MT7601_ReadChannelPwr(RTMP_ADAPTER *pAd)
{
	...
	if ( NicConfig2.field.bInternalTxALC )
	{
		...
		for ( i = 0; i < 7; i++ )
		{
			...
			pAd->TxPower[idx].Channel = i * 2;
			pAd->TxPower[idx + 1].Channel = i * 2 + 1;
...
VOID MT7601_Init(RTMP_ADAPTER *pAd)
{
	...
	*/
	...
	memcpy(pChipCap->eebuf,	MT7601_EeBuffer, EEPROM_SIZE);
	...
	*/
	...
	pChipCap->FWImageName = (UCHAR*)MT7601_FirmwareImage;
