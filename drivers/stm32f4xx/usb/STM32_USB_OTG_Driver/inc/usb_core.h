...
/* Define to prevent recursive inclusion -------------------------------------*/
    ...
    typedef enum
    {
        HC_IDLE = 0, HC_XFRC, HC_HALTED, HC_NAK, HC_NYET, HC_STALL, HC_XACTERR,
            HC_BBLERR, HC_DATATGLERR,
    } HC_STATUS;
    ...
    typedef enum
    {
        CTRL_START = 0, CTRL_XFRC, CTRL_HALTED, CTRL_NAK, CTRL_STALL,
            CTRL_XACTERR, CTRL_BBLERR, CTRL_DATATGLERR, CTRL_FAIL
    } CTRL_STATUS;
    ...
    {
        USB_INTERFACE_UNBOUND = 0, USB_INTERFACE_BINDING, USB_INTERFACE_BOUND,
    ...
    struct usb_device
    {
        ...
        struct usb_host_endpoint bulk_ep[USBH_MAX_NUM_ENDPOINTS];
    ...
    /*********************** HOST APIs ********************************************/
        ...
        USB_OTG_STS USB_OTG_HC_StartXfer(USB_OTG_CORE_HANDLE *pdev, uint8_t
            hc_num);
    ...
    /********************* DEVICE APIs ********************************************/
        ...
        uint32_t USB_OTG_ReadDevOutEP_itr(USB_OTG_CORE_HANDLE *pdev, uint8_t
            epnum);
        uint32_t USB_OTG_ReadDevAllInEPItr(USB_OTG_CORE_HANDLE *pdev);
