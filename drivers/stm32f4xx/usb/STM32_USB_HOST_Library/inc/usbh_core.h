...
/* Define to prevent recursive  ----------------------------------------------*/
    ...
    typedef enum
    {
        HOST_IDLE = 0, HOST_ISSUE_CORE_RESET, HOST_DEV_ATTACHED,
            HOST_DEV_DISCONNECTED, HOST_ISSUE_RESET, HOST_DETECT_DEVICE_SPEED,
            HOST_ENUMERATION, HOST_CLASS_REQUEST, HOST_CLASS, HOST_CTRL_XFER,
            HOST_USR_INPUT, HOST_SUSPENDED, HOST_ERROR_STATE
    } HOST_State;
